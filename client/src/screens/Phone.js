...
=======
const RTSP_URL = "rtsp://testt1:1234test@172.20.10.8:554/stream2"
>>>>>>> a5c98b7e81e6a1ee3a7d6211382d72759f584a0b
    ...
    const ensureCameraWithSource = async (brandId, desiredStatus = 'online') => {
        ...
        try {
            ...
            if (existingCamera && existingCamera.id) {
                ...
                const { data: inserted, error: insertErr } = await supabase.from('cameras').insert(payload).select('id').single();
